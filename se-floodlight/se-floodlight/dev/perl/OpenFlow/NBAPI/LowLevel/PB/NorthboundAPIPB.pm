...
{       
    ...
    unless (MessagePB::MessageType->can('_pb_fields_list')) {
        Google::ProtocolBuffers->create_enum(
            'MessagePB::MessageType',
            [
               ['SBOFMessageType', 1],
               ['NBCtrlServiceType', 2],
               ['NBInternalType', 3],
    ...
    unless (StatusReplyPB::StatusEnum->can('_pb_fields_list')) {
        Google::ProtocolBuffers->create_enum(
            'StatusReplyPB::StatusEnum',
            [
               ['SUCCESS', 1],
               ['INFO', 2],
               ['WARNING', 3],
    ...
    unless (NBCtlServicePB::ServiceMsgType->can('_pb_fields_list')) {
        Google::ProtocolBuffers->create_enum(
            'NBCtlServicePB::ServiceMsgType',
            [
               ['FunctionRequest', 1],
               ['FunctionReply', 2],
    ...
    unless (NBOFMatchPB->can('_pb_fields_list')) {
        Google::ProtocolBuffers->create_message(
            'NBOFMatchPB',
            [
                [
    ...
    unless (FunctionReplyPB->can('_pb_fields_list')) {
        Google::ProtocolBuffers->create_message(
            'FunctionReplyPB',
            [
                [
    ...
    unless (StatusReplyPB->can('_pb_fields_list')) {
        Google::ProtocolBuffers->create_message(
            'StatusReplyPB',
            [
                [
    ...
    unless (NBCtlServicePB->can('_pb_fields_list')) {
        Google::ProtocolBuffers->create_message(
            'NBCtlServicePB',
            [
                [
                ...
                [
                    Google::ProtocolBuffers::Constants::LABEL_OPTIONAL(), 
                    'FunctionRequestPB', 
                    'functionRequest', 3, undef
                ],
                [
                    Google::ProtocolBuffers::Constants::LABEL_OPTIONAL(), 
                    'FunctionReplyPB', 
                    'functionReply', 4, undef
                ],
    ...
    unless (MessagePB->can('_pb_fields_list')) {
        Google::ProtocolBuffers->create_message(
            'MessagePB',
            [
                [
    ...
    unless (FunctionRequestPB->can('_pb_fields_list')) {
        Google::ProtocolBuffers->create_message(
            'FunctionRequestPB',
            [
                [
